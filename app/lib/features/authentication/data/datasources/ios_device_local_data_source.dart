...
/// {@template ios_device_local_data_source}
/// iOS device data source contract for platform-provided device metadata.
/// {@endtemplate}
abstract class IOSDeviceLocalDataSource {
  /// {@macro ios_device_local_data_source}
  const IOSDeviceLocalDataSource();

  /// Gets raw iOS device information for registration.
  ///
  /// Returns:
