...
/// Displays one month page in the calendar carousel.
///
/// The rendered month is the [MonthlyCalendarCubit] focus plus [monthOffset].
/// It includes the weekday header, week numbers, filler days from adjacent
/// months, and day cells that delegate selection to
/// [CalendarDateSelectionCubit].
///
/// Sub-components:
/// - [_WeekdaysHeader]: Weekday labels.
/// - [_DaysGrid]: Week numbers and day cells.
/// {@endtemplate}
class MonthlyCalendar extends StatelessWidget {
  /// {@macro monthly_calendar}
  const MonthlyCalendar({super.key, required this.monthOffset});

  /// Offset from the focused month.
  ///
  /// `0` shows the focused month, `1` the next month, and `-1` the previous
  /// month.
